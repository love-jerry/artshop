...
public interface ArtPraiseArtMMapper {
     ...
     * @mbggenerated
     */
    int updateByExampleSelective(@Param("record") ArtPraiseArtM record, @Param("example") ArtPraiseArtMExample example);
     ...
     * @mbggenerated
     */
    int updateByExample(@Param("record") ArtPraiseArtM record, @Param("example") ArtPraiseArtMExample example);
